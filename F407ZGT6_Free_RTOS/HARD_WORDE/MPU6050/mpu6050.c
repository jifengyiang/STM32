...
void MpuGetData(void)
{
  ...
  uint8_t buffer[12];
	...
	HAL_I2C_Mem_Read(&hi2c2, MPU_READ, 0X3B, I2C_MEMADD_SIZE_8BIT, buffer, 6, 0xfff);				/* 读取角加速度 */
	HAL_I2C_Mem_Read(&hi2c2, MPU_READ, 0x43, I2C_MEMADD_SIZE_8BIT, &buffer[6], 6, 0xfff);		/* 读取角速度 */
